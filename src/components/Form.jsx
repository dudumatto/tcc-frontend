    ...
    return(
      ...
      <div className="p-10 flex items-center justify-center bg-gray-200 min-h-screen flex-col gap-4 rounded-lg shadow-lg">
        ...
        <form
          action="/login"
          method="POST"
          className="flex flex-col gap-4 bg-white h-full w-96 p-6 rounded-lg shadow-md"
        >
          ...
          />
          <label htmlFor="email" placeholder="Digite seu email">
            Email:
          </label>
          <input
            type="email"
            className="bg-gray-200 h-10 rounded-lg"
            placeholder="   email@universidade.edu"
          />
          ...
          />
          <label htmlFor="password" placeholder="Digite sua senha">
            Senha:
          </label>
          <input
            type="password"
